...
urlpatterns = [
    ...
    path('amadeus/predict_flight_delay/<str:city_code_from>/<str:city_code_to>/<str:departure_date>/<str:arrival_date>/<str:arrival_time>/<str:aircraft_code>/<str:carrier_code>/<str:flight_number>/<str:duration>', SelfViewPredict_flight_delay.as_view(), name='predict_flight_delay'),
    ...
    path('amadeus/recommended_locations/<str:airport_code>/<str:country_code>', SelfViewRecommended_locations.as_view(), name='recommended_locations'),
